            ...
            $metrics_raw_data = '{
                ...
                "measurements": {
                    ...
                    "metrics": {
                        ...
                        "circumference_bicep": {"name": "Bicep Circumference", "tags": [], "description": "The measurement of the circumference of the bicep at the widest point in centimeters", "validation": ["float", "side", "datetime"], "requirements": [true, true, true], "keys": ["measurement", "side", "time"]},
                        "circumference_quadricep": {"name": "Quadricep Circumference", "tags": [], "description": "The measurement of the circumference of the quadriceps at the widest point in centimeters", "validation": ["float", "side", "datetime"], "requirements": [true, true, true], "keys": ["measurement", "side", "time"]},
                        "circumference_calf": {"name": "Calf Circumference", "tags": [], "description": "The measurement of the circumference of the calf muscle at the widest point in centimeters", "validation": ["float", "side", "datetime"], "requirements": [true, true, true], "keys": ["measurement", "side", "time"]},
